...
public class FlightController {
	...
	public String fingFlight(@RequestParam("from") String from, @RequestParam("to") String to,
			@RequestParam("depaartureDate") @DateTimeFormat(pattern = "MM-dd-yyyy") Date depaartureDate,
			ModelMap modelmap) {
